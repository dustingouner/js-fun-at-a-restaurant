...
if (isFavorite === true) {
  ...
  console.log(`I recenlty ate ${food}.`)
...
var vegetables = ['spinach', 'cabbage', 'carrots', 'squash', 'asparagus']
...
var fruits = ['apples', 'oranges', 'blueberries', 'watermelon', 'pears', 'blackberries', 'bananas']
